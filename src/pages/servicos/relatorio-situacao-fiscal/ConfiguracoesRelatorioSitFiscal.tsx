...
import { Home, FileCheck, ArrowLeft } from "lucide-react";
  ...
  const handleSave = () => {
    if (!webhookUrl.trim()) {
      toast({
        ...
        description: "A URL do webhook SITFIS é obrigatória",
        variant: "destructive",
      });
      return;
    }
    ...
    localStorage.setItem(SITFIS_WEBHOOK_URL_KEY, webhookUrl.trim());
    ...
    toast({
      ...
      description: "As configurações do Relatório de Situação Fiscal foram salvas com sucesso!",
    });
  };
      ...
      <div className="container mx-auto px-4 py-8 max-w-3xl">
        <header className="mb-8">
          <div className="flex items-center gap-2 text-sm text-muted-foreground mb-6">
            ...
            <span>/</span>
            <Link to="/servicos/relatorio-situacao-fiscal" className="hover:text-foreground transition-colors">
          ...
          <div className="flex items-center justify-between">
            <div className="flex items-center gap-3">
              ...
              <div>
                ...
                <p className="text-muted-foreground">Relatório de Situação Fiscal</p>
              </div>
            </div>
            <div className="flex gap-2">
              <Link to="/servicos/relatorio-situacao-fiscal">
        ...
        <Card>
          <CardHeader>
            ...
            <CardDescription>
              Configure a URL do workflow n8n completo (SITFIS) e os CNPJs necessários para gerar o relatório
            </CardDescription>
          </CardHeader>
          <CardContent className="space-y-6">
            <div className="space-y-2">
              <Label htmlFor="webhookUrl">URL Webhook SITFIS *</Label>
              <Input
                id="webhookUrl"
                type="url"
                placeholder="https://seu-n8n.com/webhook/sitfis-completo"
                value={webhookUrl}
                onChange={(e) => setWebhookUrl(e.target.value)}
              />
              <p className="text-sm text-muted-foreground">
                Endpoint do workflow completo que solicita protocolo e emite relatório automaticamente
              </p>
            </div>
...
export default ConfiguracoesRelatorioSitFiscal;
